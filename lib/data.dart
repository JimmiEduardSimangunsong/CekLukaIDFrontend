final List<Map<String, dynamic>> healthArticles = [
  ...
  },
  {
    ...
    'sumber': 'Alodokter',
    'content': 'Luka yang dalam atau luas membutuhkan perawatan luka klinik atau di rumah sakit. Sedangkan luka yang ringan dapat diatasi melalui perawatan luka secara mandiri di rumah.'
        'Jenis-Jenis Luka'
        ...
        '2. Luka tusuk'
        'Luka tusuk disebabkan oleh benda tajam dan panjang, seperti pisau, jarum, atau paku. Meski umumnya tidak menyebabkan darah banyak keluar, luka jenis ini dapat menembus kulit hingga melukai organ dalam.Selain itu, luka tusuk juga dapat menyebabkan tetanus. Jika Anda tertusuk benda yang kotor, misalnya paku berkarat, disarankan untuk segera memeriksakan diri ke dokter. Dokter akan melakukan perawatan luka untuk mencegah infeksi, dan memberikan vaksinasi tetanus bila diperlukan.'
