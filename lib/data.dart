final List<Map<String, dynamic>> healthArticles = [
  {
    ...
    '2. Pembentukan Bekas Luka Hipertrofik (Keloid)\n\n'
    'Salah satu akibat perawatan luka yang salah adalah pembentukan bekas luka hipertrofik atau keloid. Bekas luka hipertrofik sendiri merupakan jaringan parut yang menebal dan terangkat dari permukaan kulit.\n\n'
    'Kondisi ini terjadi karena terbentuknya jaringan ikat berlebih pada bagian dalam luka. Meski tidak berbahaya, bekas luka hipertrofik dapat mengganggu penampilan yang kerap menurunkan kepercayaan diri seseorang.\n\n'
    '3. Infeksi\n\n'
    'Luka yang tidak dirawat akan mengakibatkan terjadinya infeksi bakteri atau patogen asing lainnya yang dapat membahayakan kesehatan tubuh. Infeksi akibat luka yang tidak dirawat dengan tepat dapat menimbulkan sejumlah gejala, seperti:\n\n'
    'Demam.\n\n'
    'Nyeri pada area luka.\n\n'
    'Perih yang tidak kunjung menghilang.\n\n'
    'Keluar nanah atau cairan berwarna kekuningan, kehijauan, atau kecokelatan yang berbau tidak sedap.\n\n'
    '4. Abses\n\n'
    'Infeksi akibat perawatan luka yang salah dapat menyebabkan kotoran dan nanah menumpuk di bawah kulit. Jika tidak segera ditangani, kondisi tersebut bisa menimbulkan abses atau kantong nanah yang dapat menimbulkan demam, badan terasa panas dingin, pembengkakan di bawah kulit yang terkena, serta terasa nyeri dan hangat saat disentuh.\n\n'
    '5. Selulitis\n\n'
    'Bakteri yang masuk dan menginfeksi luka terbuka juga dapat memicu terjadinya selulitis, yaitu peradangan pada kulit atau jaringan di bawahnya yang terjadi karena infeksi bakteri. Beberapa gejala umum dari selulitis adalah nyeri pada area kulit yang terinfeksi, kulit melepuh, bengkak, dan berwarna kemerahan, bernanah, serta muncul bintik-bintik merah pada kulit.\n\n'
    '6. Sepsis\n\n'
    'Komplikasi akibat perawatan luka yang salah berikutnya adalah sepsis, yaitu kondisi yang terjadi karena bakteri telah masuk dan menyebar ke seluruh tubuh melalui aliran darah.\n\n'
    'Sepsis adalah kondisi darurat medis karena dapat menyebabkan komplikasi serius seperti gagal napas, kerusakan organ permanen, gangguan peredaran darah, penurunan kesadaran, hingga kematian.\n\n',
  },
  {
    ...
    '1.Membersihkan luka dari nanah dan sel-sel kulit mati.\n\n'
    '2.Mencegah luka dari infeksi.\n\n'
    '3.Mengganti perban atau balutan.\n\n'
    ...
    'Luka akut terjadi akibat adanya jaringan yang rusak karena trauma. Luka jenis ini bisa didapatkan secara sengaja, seperti dalam luka prosedur bedah.Ia juga bisa terjadi karena kecelakaan yang disebabkan oleh benda tumpul, proyektil, panas, listrik, bahan kimia, atau gesekan. Luka ini biasanya bisa sembuh dengan sendirinya, namun lebih baik dengan melakukan tindakan awal seperti menggunakan antiseptic atau minyak tertentu.\n\n'
    ...
    '1.Luka terbuka lebih dalam dari 1,5 cm.\n\n'
    '2.Pendarahan tidak berhenti walaupun dengan tekanan langsung.\n\n'
    '3.Pendarahan berlangsung lebih dari 20 menit.\n\n'
    '4.Pendarahan hasil dari kecelakaan serius.\n\n',
  },
  {
...
//ini bagian batasan luka

final List<Map<String, dynamic>> woundImages = [
  {
    'title': 'Luka Sayat',
...
'Meskipun demikian, penting untuk diingat bahwa jika Anda merasa ragu atau luka tampak serius, lebih baik berkonsultasi dengan profesional medis untuk evaluasi lebih lanjut dan saran perawatan yang tepat. Tindakan pencegahan selalu lebih baik daripada menunggu hingga masalah menjadi lebih serius.',
  ...
  {
    'title': 'Luka Lecet',
    'image': 'assets/lecet.jpeg',
    'content':'\n\nUkuran luka: Luka lecet yang relatif kecil dan dangkal cenderung dapat diobati di rumah. Biasanya, luka dengan panjang kurang dari satu inci dan tidak terlalu dalam bisa dianggap sebagai luka ringan.\n\n'
    'Tidak adanya pendarahan berat: Jika luka tidak mengalami pendarahan berat atau mengalir secara terus-menerus, kemungkinan besar dapat diobati di rumah. Pendarahan ringan atau berhenti setelah beberapa saat tekanan diberikan pada luka juga merupakan tanda bahwa luka mungkin tidak memerlukan perawatan medis darurat.\n\n'
    'Lokasi luka: Luka yang terletak di bagian tubuh yang tidak vital atau tidak menyebabkan kerusakan pada organ dalam cenderung bisa diobati di rumah. Namun, luka yang terletak di area seperti wajah, leher, atau area dengan pembuluh darah besar lainnya mungkin memerlukan perhatian medis lebih lanjut.\n\n'
    'Tidak adanya benda asing dalam luka: Jika luka tidak mengandung benda asing atau tidak terkontaminasi dengan bahan berbahaya, itu merupakan tanda bahwa luka mungkin dapat diobati di rumah.\n\n'
    'Tidak adanya tanda-tanda infeksi: Jika tidak ada tanda-tanda infeksi seperti kemerahan, pembengkakan, atau nanah di sekitar luka, itu menunjukkan bahwa luka mungkin bisa diatasi dengan perawatan sederhana di rumah.\n\n'
  ...
  },
  {
    ...
    'Luka bakar ringan atau luka bakar derajat 1 memiliki karakteristik luka yang tidak lebih dari 8 cm. Luka ini umumnya tidak menimbulkan kondisi serius karena hanya meliputi lapisan kulit paling luar.\n\n'
  'Luka bakar ringan biasanya memunculkan rasa nyeri, kemerahan, dan kadang disertai dengan bengkak. Jenis luka bakar ini sering kali disebabkan oleh kontak langsung dengan benda panas atau karena terbakar sinar matahari (sunburn).\n\n'
